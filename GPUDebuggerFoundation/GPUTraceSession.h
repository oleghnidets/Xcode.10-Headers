...
@class DVTDocumentLocation, DVTFileDataType, DVTStackBacktrace, DVTSymbol, DYFuture, DYSymbolicator, GPUDebuggerController, GPUTraceReplayController, IDEFileReference, IDELaunchSession, NSArray, NSDictionary, NSImage, NSNull, NSObject<OS_dispatch_queue>, NSString, NSURL;
