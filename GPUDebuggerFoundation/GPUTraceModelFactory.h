...
@class DVTStackBacktrace, DYFuture, DYGLCaptureSessionInfo, GPUDebuggerController, GPUTraceDisplayableItem, GPUTraceProcessItem, GPUTraceSession, NSArray, NSMapTable, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
