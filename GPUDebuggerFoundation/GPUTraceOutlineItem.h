...
#import "GPUFilterableObject.h"
#import "IDEDebugNavigableModel.h"

@class GPUDebuggerController, GPUGlobalStateManager, GPUTraceAPIItem, GPUTraceModelFactory, IDELaunchSession, NSArray, NSMutableArray, NSMutableSet, NSObject<OS_dispatch_queue>, NSSet, NSString, NSURL;
