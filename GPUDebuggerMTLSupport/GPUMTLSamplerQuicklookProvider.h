...
#import "GPUStateValueQuicklookProvider.h"
#import "IDEVariablesViewQuickLookProvider.h"

@class GPUMTLQuicklookProvider, GPUQuicklookSamplerItem, GPUSharedTabUIState, GPUStateValueQuicklookProvider, GPUTraceSubEditor, NSObject<OS_dispatch_queue>, NSString, NSURL, NSView;
