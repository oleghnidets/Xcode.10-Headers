...
@class GPUMTLQuicklookProvider, GPUMTLTextureQuicklookView, GPUStateValueQuicklookProvider, NSLayoutConstraint, NSObject<OS_dispatch_queue>, NSSlider, NSString, NSURL, NSView;
