...
@class DTOSLogLoaderFetchTicket, NSDate, NSError, NSMutableArray, NSMutableData, NSMutableDictionary, NSPredicate, OSLogEventLiveStore, OSLogEventLiveStream, OSLogEventStore, OSLogEventStream, XRIntKeyedDictionary, XRMobileAgent<DTOSLogLoaderVisitor>;
