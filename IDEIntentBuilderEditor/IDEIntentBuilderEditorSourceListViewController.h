...
@class DVTBorderedView, DVTGradientImageButton, DVTGradientImagePopUpButton, DVTSearchField, IDEIntentBuilderIndentationAdjustingOutlineView, IDEIntentBuilderModel, IDEUtilityPlaceholderView, NSString;
...
@property __weak IDEUtilityPlaceholderView *placeholderView; // @synthesize placeholderView=_placeholderView;
