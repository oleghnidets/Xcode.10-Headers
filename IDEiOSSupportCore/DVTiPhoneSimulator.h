...
#import "DVTTestingiPhoneSimulator.h"
...
@class DTAssetProviderService, DTXChannel, DTXConnection, DVTDevice, DVTDeviceOperation, DVTDispatchLock, DVTObservingToken, DVTPlatform, DVTProxiedDeviceSet, DVTSimulatorApplication, NSArray, NSDictionary, NSMutableSet, NSNumber, NSObject<OS_dispatch_semaphore>, NSSet, NSString, SimDevice, SimDeviceSet, SimDeviceType;
