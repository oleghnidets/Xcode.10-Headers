...
@class DTXChannel, DVTDeviceOperation, DVTDispatchLock, DVTNotificationToken, DVTObservingToken, DVTPlatform, IDELaunchParametersSnapshot, NSError, NSMutableArray, NSMutableSet, NSObject<DTDKRemoteDeviceToken>, NSObject<OS_dispatch_queue>, NSOrderedSet, NSSet, NSString;
