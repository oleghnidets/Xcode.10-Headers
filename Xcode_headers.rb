...
xcode_folder(xcode, 'Developer/Library/Frameworks'),
xcode_folder(xcode, 'Developer/Library/MigrationFrameworks'),
xcode_folder(xcode, 'Developer/Library/Frameworks'),
xcode_folder(xcode, 'Developer/Library/PrivateFrameworks'),
