...
@class DVTOutlineView, DVTTableCellView, DVTTableRowView, IDEDebugNavigator, IDELaunchSession, IDENavigableItem, IDEProcessActionPopUpCell, NSArray, NSArray<IDEDebugGaugeDataSource>, NSDictionary, NSMenu, NSMutableDictionary, NSOutlineView, NSSet, NSString, NSTableCellView, NSView;
