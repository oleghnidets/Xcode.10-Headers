...
@class DTXProxyChannel, NSObject<OS_dispatch_queue>, NSString, NSUUID, XCTProtocolVersion;

@interface XCTDaemonMediatedTestRunnerConnectionProvider : NSObject <XCTDaemonProxyProviding, XCTTestRunnerConnectionProvider, XCTConfigurableDebugLogger>
{
