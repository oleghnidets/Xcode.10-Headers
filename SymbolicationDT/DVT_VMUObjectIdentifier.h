...
@class DVT_VMUClassInfo, DVT_VMUClassInfoMap, DVT_VMUNonOverlappingRangeArray, DVT_VMUTaskMemoryScanner, NSHashTable, NSMapTable, NSMutableDictionary, NSMutableSet, NSString;
