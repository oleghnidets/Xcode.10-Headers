...
#import "DVTNetworkDeviceServiceBrowserDelegate.h"

@class DVTDispatchLock, DVTNetworkDeviceServiceBrowser, DVTObservingToken, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
