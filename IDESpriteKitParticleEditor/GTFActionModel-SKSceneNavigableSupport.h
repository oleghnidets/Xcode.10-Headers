...
@class DVTDocumentLocation, DVTFileDataType, IDEFileReference, NSArray, NSImage, NSNull, NSObject<SKSceneNavigating>, NSString, NSURL, _TtC13DVTFoundation9DVTSymbol;
