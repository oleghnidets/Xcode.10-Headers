...
@class DVTDocumentLocation, DVTFileDataType, IDEFileReference, NSArray, NSImage, NSNull, NSObject<SKSceneNavigating>, NSString, NSURL, SKSceneNavigableCategory, SKSceneNavigableNode, _TtC13DVTFoundation9DVTSymbol;
