...
@class IBAbstractLayoutConstraintAbstraction, IBAutolayoutConstraintDrawable, IBLayoutConstraint, IBLayoutConstraintColorSpecifier, NSColor, NSImage, NSObject<IBAutolayoutItem>, NSString;
