...
@class DVTStackBacktrace, IBAbstractPlatformToolExecutionContext, IBMessageSendChannel, IBPlatformToolLaunchContext, NSMutableArray, NSObject<IBAbstractPlatformToolProxyDelegate>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSPipe, NSString;
