...
@class DVTBorderedView, DVTSearchField, IBAbstractDocumentEditor, IBStructureAreaDockLabelContainer, IDEViewController<IBSelectionProvider>, NSLayoutConstraint, NSMutableDictionary, NSSet, NSString, NSView;
