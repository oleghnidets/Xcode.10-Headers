...
#import "DVTFilterTokenFieldControllerDelegate.h"
#import "DVTInvalidation.h"
#import "IDEDebugNavigableContentDelegate.h"

@class DBGGaugeCPUTrayCell, DBGGaugeMemoryTrayCell, DBGProcessNavigableItem, DBGViewDebuggerAdditionUIController, DVTObservingToken, DVTStackBacktrace, IDEDebugNavigator, IDEDebugSession, IDEGaugeDocumentLocation, IDENavigableItem, IDENavigatorOutlineView, IDENavigatorSearchFilterControlBar, IDENavigatorTokenFilterControlBar, IDEStackFrame, IDEThread, IDEWorkspaceTabController, NSArray<IDEDebugGaugeDataSource>, NSMenuItem, NSMutableSet, NSSet, NSString, NSView, XRMemoryGraphDebuggerAdditionUIController;
