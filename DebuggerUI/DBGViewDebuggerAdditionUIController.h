...
@class DBGHierarchyNavigationCoordinator, DBGViewDebuggerAddition, DBGViewObject<DBGFocusableViewObject>, DVTExtension, DVTObservingToken, DVTStackBacktrace, DVTStateToken, IDEWorkspaceTabController, NSLock, NSString;
