...
@class DBGSceneViewController, DBGViewDebuggerAdditionUIController, DBGViewDebuggerDocument, DBGViewObject<DBGFocusableViewObject>, DBGViewWindow, DVTBorderedView, DVTDelayedInvocation, DVTGradientImageButton, DVTGradientImagePopUpButton, DVTObservingToken, DVTRangeSliderCell, IDECanvasAppearanceSwitcherController, NSArray, NSLayoutConstraint, NSMenuItem, NSProgressIndicator, NSSegmentedControl, NSSet, NSSlider, NSString, NSTextField, NSTouchBar, NSView, NSVisualEffectView;
